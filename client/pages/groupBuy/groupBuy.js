...
Page({
  data: {
    ...
    goodsImg: 'http://wx4.sinaimg.cn/mw690/006p6Tvely1g3c8aoei72j31f50nnh38.jpg', 
  },
  ...
  　　　　// 此处可以修改 shareObj 中的内容
      if(that.data.flag==true){
        shareObj.path = '/pages/groupBuy/groupBuy_share?mct_id=' + that.data.mct_id + "&price=" + that.data.txtOrderCode + "&mct_name=" + that.data.mct_name + '&number=' + that.data.SumGroup + "&name=" + that.data.name + "&phone=" + that.data.phone;
      }else{
