...
Page({
  ...
  addUser: function (e) {
    ...
    wx.request({
      url: 'https://104724433.xuanxuanballe.club/weapp/form_add_picture',
      ...
      data: { type: this.data.type,descrp: this.data.descrp, URL: this.data.URL, },
  ...
  delUser: function (e) {
    ...
    var that = this
    wx.request({
      url: 'https://104724433.xuanxuanballe.club/weapp/form_del_picture',
      // url: 'https://rv647fej.qcloud.la/weapp/form',
      method: "POST",
      header: {
        'Content-Type': 'application/x-www-form-urlencoded'
